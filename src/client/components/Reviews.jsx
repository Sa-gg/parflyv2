...
const Reviews = () => {
  return (
    <section class="pb-12 mx-auto md:pb-20 max-w-7xl mt-[25vw] md:mt-0">
      <link
        rel="stylesheet"
        href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css"
      />
      <div class="py-4 text-center md:py-8">
        <h2 class="text-2xl font-bold tracking-wide text-center uppercase text-primary">
          Reviews
        </h2>
        <p class="mt-2 tracking-tight text-text text:xl md:text-2xl">
          We have some fans.
        </p>
      </div>
      ...
      <div class="gap-8 space-y-8 md:columns-2 lg:columns-3 px-[5vw]">
        <div class="p-8 bg-white border border-gray-100 shadow-2xl aspect-auto rounded-3xl shadow-gray-600/10 flex flex-col dark:bg-gray-800 dark:border-gray-700 ">
            ...
            <div class="flex-1 flex justify-between items-start">
              ...
              >
                <div class="flex items-center">
                  <svg
                    class="w-4 h-4 text-primary ms-1"
                    aria-hidden="true"
          ...
          <p class="mt-8 flex-1 text-text">
            Parfly has made my job so much easier. The app is user-friendly and
            helps me find delivery jobs quickly. Highly recommend it to all
            drivers! <br />
          </p>
        </div>
        ...
        <div class="p-8 bg-white border border-gray-100 shadow-2xl aspect-auto rounded-3xl shadow-gray-600/10 flex flex-col dark:bg-gray-800 dark:border-gray-700">
          ...
          <p class="mt-8 flex-1 text-text">
            I love using Parfly for my deliveries. The service is fast and
            reliable, and the drivers are always professional. Great experience
            every time! <br />
          </p>
        </div>
        ...
        <div class="p-8 bg-white border border-gray-100 shadow-2xl aspect-auto rounded-3xl shadow-gray-600/10 flex flex-col dark:bg-gray-800 dark:border-gray-700">
          ...
          <p class="mt-8 flex-1 text-text">
            Parfly has been a game-changer for me. The app's features make it
            easy to manage my deliveries and communicate with customers. Highly
            recommend it!
          </p>
        </div>
        ...
        <div class="p-8 bg-white border border-gray-100 shadow-2xl aspect-auto rounded-3xl shadow-gray-600/10 flex flex-col dark:bg-gray-800 dark:border-gray-700">
          ...
          <p class="mt-8 flex-1 text-text">
            The Parfly app is fantastic! It's so easy to book a delivery, and
            the drivers are always prompt and courteous. I couldn't be happier
            with the service.
          </p>
        </div>
        ...
        <div class="p-8 bg-white border border-gray-100 shadow-2xl aspect-auto rounded-3xl shadow-gray-600/10 flex flex-col dark:bg-gray-800 dark:border-gray-700">
          ...
          <p class="mt-8 flex-1 text-text">
            Parfly offers great value for drivers. The app is intuitive, and the
            support team is always ready to help. It's a must-have for anyone in
        ...
        <div class="p-8 bg-white border border-gray-100 shadow-2xl aspect-auto rounded-3xl shadow-gray-600/10 flex flex-col dark:bg-gray-800 dark:border-gray-700">
          ...
          <p class="mt-8 flex-1 text-text">
            Absolutely love Parfly! The app is easy to use, and the delivery
            service is top-notch. My packages always arrive on time, and the
