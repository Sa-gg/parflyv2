...
const Navbar = () => {
  return (
    <nav id="navbar" className="bg-white border-gray-200 dark:bg-gray-900 fixed w-full transition-colors duration-300 ease-in-out z-[999]">
        <div
        ...
        >
          ...
          <div
            className="flex items-center md:order-2 space-x-2 md:space-x-0 rtl:space-x-reverse"
          >
            <button
            ...
            <NavLink
               to="/register"
              className="text-white bg-[#FF6600] font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
              >Sign up</NavLink>
          ...
          >
            <ul
              id="navbar-ul"
              className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:space-x-4 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700"
            >
              <li>
                <NavLink
                  to="/business"
